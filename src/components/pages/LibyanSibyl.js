  ...
  return (
      <>
        ...
        <div className='intro'>
            ...
            <p>Michelangelo’s Libyan Sibyl is one of his many iconic works located on the Sistine Chapel ceiling. The Sibyls, which were prophetesses from the ancient world, were included in the ceiling as the Church considered them to set the stage for Christianity. The Libyan Sibyl was one of the last to be added on the ceiling in 1511, and was preceded by a sketch that gives great insight to the creation of the Sibyl and the motivation behind Michelangelo’s masculine portrayal of the subject. Indeed, Michelangelo’s portrayal of the Libyan Sibyl is not the only time he paints women with masculine features. In The Last Judgment, St. Catherine is depicted in a powerful, masculine stance, and even in the Sistine Chapel, some of the other sibyls are equally masculine. Some attribute this to Michelangelo’s perceived homoexuality and his fascination with the male anatomy. However, in a larger sense, it is the theme of idealization that appears in a different way; Michelangelo’s idealized human figure is male and masculine, so even in his drawings of women, he perpetuates the patriarchal outlook of the times in his depictions of masculine women.</p>
        </div>
        <div className='intro'>
